...
const isValidMove = (
  ...
  // Directions possibles pour vérifier les captures (8 directions autour de la case)
  ...
  for (const direction of directions) {
    ...
    // Tant qu'on est dans les limites du plateau
    while (i >= 0 && i < 64 && board[i] === opponent) {
      i += direction; // Continuer dans la même direction
      foundOpponent = true;
    }
