...
type BoardProps = {
    board: Cell[], currentPlayer: Player, setNotification: void, setCurrentPlayer: void, setBoard: void
}

const Board = ({ board, currentPlayer, setNotification, setCurrentPlayer, setBoard }: BoardProps) => {
